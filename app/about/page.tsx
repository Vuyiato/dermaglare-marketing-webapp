        ...
        <div className="about-hero-container">
          <div className="about-hero-content">
            ...
            <p className="about-hero-description">
              ...
              experience with a deep passion for enhancing your skin, hair, and
              nail health. Her proficiency spans across medical dermatology,
              aesthetics, and dermatology surgery, ensuring comprehensive care
              for both adult and pediatric skin diseases.
            </p>
            <p className="about-hero-description">
              From managing common issues like acne, pigmentation, and eczema to
              tackling life-threatening skin infections and skin cancer, Dr.
              Nkehli provides each patient with individualized, cutting-edge
              treatments.
            </p>
            ...
            <div className="value-card">
              <div className="value-icon">
                ...
                >
                  ...
                  <path
                    d="M12 11c-3 0-6 1.5-6 4v2h12v-2c0-2.5-3-4-6-4z"
                    strokeWidth="2"
                  />
        ...
        <div className="journey-container">
          ...
          <div className="journey-content">
            ...
            <p className="journey-description">
              Dr Nkehli's commitment to medical practice began with a Bachelor
              of Medicine and Surgery qualification from the Nelson R Mandela
              School of Medicine, University of KwaZulu-Natal, in 2000.
              Following internships and service in hospitals across South
              Africa, she gained invaluable global exposure as a resident
              medical officer in England between 2003-2005. This diverse
              experience enriched her knowledge and dedication to delivering
            ...
            <div className="accordion-container">
              <div
                className={`accordion-item ${
                  openAccordion === "difference" ? "active" : ""
                }`}
              >
                <button
                ...
                >
                  ...
                  <svg
                    ...
                    className={`accordion-icon ${
                      openAccordion === "difference" ? "rotate" : ""
                    }`}
                  >
                    <path
                      d="M6 9l6 6 6-6"
                ...
                {openAccordion === "difference" && (
                  <div className="accordion-content">
                    <p>
                      ...
                      including leprosy. Her dedication extends to community
                      outreach and education, ensuring that quality
              ...
              >
                ...
                {openAccordion === "academic" && (
                  <div className="accordion-content">
                    <p>
                      Dr Nkehli's academic excellence is demonstrated through
                      her Fellowship of the College of Dermatologists of South
                      Africa and her Master's degree in Medicine specializing in
                      Dermatology from the University of the Witwatersrand. Her
                      expertise is recognized both nationally and
                      internationally.
                    </p>
                  </div>
                )}
        ...
        <div className="about-footer-container">
          <div className="footer-brand-section">
            ...
            <p className="footer-brand-description">
              Your skin health journey begins here at
              <br />
              Dermaglare Skin. With Dr Jabu Nkehli's expert
              <br />
              guidance, we ensure your skin shines its
              <br />
              brightest.
            </p>
          ...
          <div className="footer-services-section">
            ...
            <ul className="footer-links-list">
              <li>
                <Link href="/services/paediatric">Paediatric Dermatology</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/services/cosmetic">Cosmetic Dermatology</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-contact-section">
            ...
            <ul className="footer-contact-list">
              ...
              <li className="footer-contact-item">
                ...
                <span>
                  Suite 3, East Wing Wingwood Medical
                  <br />
                  Suites Life Bedford Gardens 8 Leicester
                  <br />
                  Rd Bedford Gardens
                </span>
              </li>
