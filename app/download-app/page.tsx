  ...
  return (
    <main className="download-app-page">
          ...
          <div className="hero-content">
            <div className="content-wrapper">
              ...
              <p className="hero-description">
                Book appointments, access medical records, get reminders, and
                consult with Dr. Jabu Nkehli - all from the convenience of your
                smartphone.
              </p>
              ...
              <div className="download-buttons">
                ...
                <div className="store-buttons">
                  <a
                    href="https://drive.google.com/file/d/1S-R2RgyrwmHOx0-Xh4ejR2fYgWM3dFdS/view?usp=sharing"
                    target="_blank"
        ...
        <div className="features-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Manage your dermatology care with powerful features designed for
              convenience
            </p>
          </div>
      ...
      <p className="help-text">
        ...
        to view or download instructions on how to download the Dermaglare Skin
